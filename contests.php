...
<a href="#" class="scrollup">Scroll</a>
            ...
            <div id="container">
                ...
                <div id="content">
					...
					<div id="tutorial">
						<a href="<?php if(isset($_SESSION['user_id'])) echo '#contest'; else echo '?response=Trebuie+sa+te+loghezi#loginModal';?>"><div id="contestUpload" class="btn">Participa!</div></a>
						<?php include 'classes/contests.php' ?>
...
var comm=0;
var xmlhttp;
var photosGallery=<?php echo sizeof($membership->get_Contest_Images($_GET["contest"]))/2;?>;
//alert(photosGallery);
...
function scroll(){
    ...
    if((contentHeight - pageHeight - scrollPosition) < dif){
        ...
        if (n/2<photos)
        {
        var url="getImages.php?contest=1&n="+n;
        xmlhttp.open("GET",url,true);
        xmlhttp.send();
