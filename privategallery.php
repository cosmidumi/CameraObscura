...
<title>Album: <?php echo $membership->get_Album($_GET["album"])?></title>
...
<a href="#" class="scrollup">Scroll</a>
            ...
            <div id="container">
                ...
                <div id="content">
                    ...
                    <br/>
                     <h2 style="position:relative; text-align:left; left:40px; font-size:18px; bottom:10px"><?php echo ' My Gallery '; ?><img src="images/icons/gallery.png" style="width:40px; height:30px; top:10px; position:relative; border-radius:30px;"><?php echo ' ' .  $membership->get_Album($_GET["album"])?></h2>
                <div id="gallery"></div>    
                </div>
</div>
<div id="footer"></div>
...
var n = 0;
var xmlhttp;
var photosGallery=<?php echo $membership->get_Member_Number_Photos($_GET["user"], $_GET["album"])?>;
...
$("#frame5").hide();
$("#frame7").hide();
setTimeout(function() { $("#frame5").show();
$("#frame7").show();}, 550);
});
              ...
              for(i=0; i<files.length; i++){
                  if((files[i] != "")&&(photosGallery>0)){
                    ...
                    $("#imask"+files[i]).append('<img id="frameit'+files[i]+'"src="images/icons/frame.png" title="Inramare" name="unframed" style="height:32px; width:32px; position:relative;top:10px;float:right; right:30px;">');
                     $("#imask"+files[i]).append('<a href="?user=<?php echo $_SESSION["user_id"];?>&album=<?php echo $_GET["album"]?>&del_photo='+files[i]+'"><img src="images/icons/minus_big.png" title="Sterge" style="height:32px; width:32px; position:relative;top:10px;float:right; right:50px;"></a>');
                     <?php
                     else:?>
...
function scroll(){
  ...
  //  alert(photosGallery);
        ...
        var url="getImages.php?user="+galleryID+"&n="+n+"&album="+album;
        xmlhttp.open("GET",url,true);
        xmlhttp.send();
