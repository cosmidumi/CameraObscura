...
<title>Galerie Publica - Poze Recente</title>
...
<a href="#" class="scrollup">Scroll</a>
            ...
            <div id="container">
                ...
                <div id="content">
                    ...
                    <br/>
                     <h2 style="position:relative; text-align:left; left:40px; font-size:18px; bottom:10px"> Galerie Publica <img src="images/icons/gallery.png" style="width:40px; height:30px; top:10px; position:relative; border-radius:30px;"> Poze Recente</h2>
                <div id="gallery"></div>    
                </div>
</div>
<div id="footer"></div>
...
var comm=0;
var xmlhttp;
var photosGallery=<?php 
if (isset($_SESSION['user_id']))
echo $membership->get_Member_Number_All_Photos($_SESSION['user_id']);
else echo $membership->get_Member_Number_All_Photos(0);
?>;
//alert(photosGallery);
