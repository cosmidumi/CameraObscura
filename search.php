...
<a href="#" class="scrollup">Scroll</a>
            ...
            <div id="container">
                ...
                <div id="content">
                    ...
                    <br/>
                     <h2 style="position:relative; text-align:left; left:40px; font-size:18px; bottom:10px"> Cautare <img src="images/icons/gallery.png" style="width:40px; height:30px; top:10px; position:relative; border-radius:30px;"></h2>
                <div id="gallery"></div>    
                </div>
</div>
<div id="footer"></div>
...
echo sizeof($membership->get_Images_Search($_SESSION['user_id'],$_GET['s']));
?>;
//alert(photosGallery);
...
function scroll(){
  ...
  //  alert(photosGallery);
        var url="getImages.php?n="+n+"&s=<?php echo $_GET['s']?>";
        xmlhttp.open("GET",url,true);
        xmlhttp.send();
