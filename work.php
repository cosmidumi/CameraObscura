...
<title>Galerie Publica - Temele Utilizatorilor</title>
...
<a href="#" class="scrollup">Scroll</a>
            ...
            <div id="container">
                ...
                <div id="content">
                    ...
                    <br/>
                     <h2 style="position:relative; text-align:left; left:40px; font-size:18px; bottom:10px"> Galerie Publica <img src="images/icons/gallery.png" style="width:40px; height:30px; top:10px; position:relative; border-radius:30px;"> Temele Utilizatorilor</h2>
                     <p style="text-align:left; left:50px; position:relative; ">Ajuta utilatorii sa creasca! Voteaza-le pozele!</p>
                <div id="gallery"></div>    
                </div>
</div>
<div id="footer"></div>
...
var comm=0;
var xmlhttp;
var photosGallery=<?php echo sizeof($membership->get_Work_Images())/2;?>;
//alert(photosGallery);
...
function scroll(){
    ...
    if((contentHeight - pageHeight - scrollPosition) < dif){
        ...
        if (n/2<photos)
        {
        var url="getImages.php?work=1&n="+n;
        xmlhttp.open("GET",url,true);
        xmlhttp.send();
